<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
    ...
    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
        ...
        <a href="../../demo1/dist/index.html">
            <img alt="Logo" src="/images/ukpbj-03.png" class="h-35px logo" />
        </a>
        <!--end::Logo-->
        <!--begin::Aside toggler-->
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div class="menu-item ">
                    ...
                    <a class="menu-link {{ request()->is('usulan-tender-seleksi') ? 'active' : '' }}" href="/usulan-tender-seleksi">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/art/art002.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25"
                    ...
                    <a class="menu-link {{ request()->is('usulan-tender-dikecualikan') ? 'active' : '' }}" href="/usulan-tender-dikecualikan">
                        ...
                        <span class="menu-title">Permohonan Proses Pengadaan Dikecualikan</span>
                    </a>
                </div>
                ...
                <div class="menu-item">
                    <a class="menu-link" href="anggota-pokja">
                        ...
                        <span class="menu-title">Anggota Pokja</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link" href="/jenis-tender">
                        ...
                        <span class="menu-title">Jenis Tender</span>
                    </a>
                </div>
                <div class="menu-item">
