                        ...
                        type="hidden" />
                                    ...
                                    <div>
                                        ...
                                        <div v-if="checkExist(`berkas_${index}_${indexi}`)||i.berkas"
                                            ...
                                            <img data-bs-target="#kt_modal_new_card"
                                                @click="pathmodalactive='storage/berkas/'+i.berkas" data-bs-toggle="modal"
                                ...
                                <div class="col">
                                    <div  class="d-flex justify-content-between">
                                        ...
                                        <span @click="delDoc(item,i,indexi)" style="cursor: pointer" class="text-danger fw-bolder">Hapus</span>
                                    </div>
                                    <input type="text"
